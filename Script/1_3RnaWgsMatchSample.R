...
# ----> Gene expression ----
gene_data <- read.csv("D:/Research/Data/Redo/log2cpm_clean_gene.csv",header = T,row.names = 1)
...
genus_rna <- read.csv("D:/Research/Data/Raw/LUAD_RNA_seq_abundance_only138.csv", header = TRUE,row.names = 1)
