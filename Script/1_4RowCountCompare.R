...
filter_rna <- read.csv("Metadata_LUAD_RNA_138sample.csv")
filter_wgs <- read.csv("Metadata_LUAD_WGS_138sample.csv")
...
wgs_mean <- mean(compare_table$wgs_sum)
rna_mean <- mean(compare_table$rna_sum)
